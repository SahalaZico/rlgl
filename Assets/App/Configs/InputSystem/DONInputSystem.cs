...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/App/Configs/InputSystem/DONInputSystem.inputactions".
/// </summary>
/// <remarks>
...
public partial class @DONInputSystem: IInputActionCollection2, IDisposable
{
    ...
    ~@DONInputSystem()
    {
        UnityEngine.Debug.Assert(!m_CharacterControl.enabled, "This will cause a leak and performance issues, DONInputSystem.CharacterControl.Disable() has not been called.");
    }
